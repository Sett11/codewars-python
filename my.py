def countWins(w,c):
    return len([i for i in w if i['country']==c])

print(countWins([{ 'season': '1996-97', 'team': 'Borussia Dortmund', 'country': 'Germany' },
{ 'season': '1997-98', 'team': 'Real Madrid', 'country': 'Spain' }, 
  ...
  { 'season': '2015-16', 'team': 'Real Madrid', 'country': 'Spain' }],'Spain'))